...
**YouTube iframe embeds fail with these errors:**

1. "Video unavailable - Playback on other websites has been disabled by the video owner"
2. "Video unavailable" (generic blocking)

**Why it happens:**

- Video owners can disable embedding
- Corporate/school firewalls block YouTube embed domains
- Privacy filters block iframes
- Network restrictions

**Impact:** Users can't preview videos before downloading, leading to wasted downloads and poor UX.
